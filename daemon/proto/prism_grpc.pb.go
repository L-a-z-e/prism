...
const (
	AgentService_RegisterAgent_FullMethodName    = "/prism.AgentService/RegisterAgent"
	AgentService_Heartbeat_FullMethodName        = "/prism.AgentService/Heartbeat"
	AgentService_UpdateTaskStatus_FullMethodName = "/prism.AgentService/UpdateTaskStatus"
)
...
func (c *agentServiceClient) UpdateTaskStatus(ctx context.Context, in *UpdateTaskStatusRequest, opts ...grpc.CallOption) (*UpdateTaskStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAgentServiceServer) UpdateTaskStatus(context.Context, *UpdateTaskStatusRequest) (*UpdateTaskStatusResponse, error) {
...
func _AgentService_UpdateTaskStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).UpdateTaskStatus(ctx, req.(*UpdateTaskStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "prism.AgentService",
